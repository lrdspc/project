...
const ReviewAndFinalize: React.FC = () => {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6">
      ...
      <ProgressBar currentStep={6} totalSteps={6} labels={inspectionSteps} />
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            <div className="p-6 text-center">
              ...
              <p className="text-gray-600 mb-6">
                O relatório de vistoria para {inspectionData.client} foi gerado
                e está pronto para ser compartilhado.
              </p>
              ...
              <div className="p-6 border-b border-gray-200">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {inspectionData.constructionYear}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <p>
                        {inspectionData.photoCount} fotos adicionadas ao
                        relatório
                      </p>
                    </div>
                    <div className="mt-1 text-right">
