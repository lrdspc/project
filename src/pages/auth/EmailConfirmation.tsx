      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="text-center">
            ...
            <h3 className="mt-3 text-lg font-medium text-gray-900">Confirme seu email</h3>
            ...
            {process.env.NODE_ENV !== 'production' && (
              <div className="mt-6 p-3 bg-yellow-50 border border-yellow-200 rounded-md text-left">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-yellow-800">Modo Desenvolvimento</h3>
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>Em ambientes de desenvolvimento, os emails podem não ser enviados automaticamente.</p>
                      <p className="mt-2">Você pode testar a confirmação de email visitando manualmente:</p>
                      <p className="mt-1">{`${window.location.origin}/auth/callback?type=signup`}</p>
                      <p className="mt-2">OU configurar um serviço SMTP no painel do Supabase em:</p>
                      <p className="mt-1">Authentication &gt; Email Templates</p>
                    </div>
                  </div>
                </div>
              </div>
