...
import { Info, Camera, ChevronDown, ChevronUp } from 'lucide-react';
...
const NonConformityItem: React.FC<NonConformityItemProps> = ({
  ...
  return (
    <div
      className={`mb-4 border rounded-lg transition-all ${isSelected ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white'}`}
    >
      <div className="p-4">
